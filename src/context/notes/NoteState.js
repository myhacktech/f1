...
const NoteState = (props) => {
  ...
  const fetchData =  async() => {
    try {
      const response = await fetch("https://backend-app-gy75.onrender.com/api/auth/getuser/", {
        method: "GET",
        headers: {
  ...
  const getNote = async () => {
    ...
    const response = await fetch("https://backend-app-gy75.onrender.com/api/notes/fetchallnotes", {
      method: "GET",
      headers: {
  ...
  const addNote = async (title, description, tag) => {
    const response = await fetch("https://backend-app-gy75.onrender.com/api/notes/addnote", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "auth-token": Cookies.get('authtoken'),
  ...
  const deleteNote = async (id) => {
    //Api call to delete
    const response = await fetch(`https://backend-app-gy75.onrender.com/api/notes/deletenote/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        "auth-token": Cookies.get('authtoken'),
  ...
  const editNote = async (id, title, description, tag) => {
    ...
    const response = await fetch(`https://backend-app-gy75.onrender.com/api/notes/updatenote/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-token": Cookies.get('authtoken'),
